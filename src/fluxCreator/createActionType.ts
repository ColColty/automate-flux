...
export default function createActionType(actionTypeController: ActionTypeController, parsedModel: ParsedModel) {
    ...
    if (data.length) {
        ...
        actionTypeController.addLine(generateModelImport(parsedModel.interfaceName))

        actionTypeController.addActionType(parsedModel.interfaceName, actionName, parsedModel.propertiesSend || [])
        actionTypeController.addActionType(parsedModel.interfaceName, actionName, parsedModel.propertiesSuccess || [], true)
        actionTypeController.addActionType(parsedModel.interfaceName, actionName, errorProperties, false)
