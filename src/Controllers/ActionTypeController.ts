...
import { FailureAppendType, ModelActionType, SuccessAppendType } from "../Constants/ActionTypeConstants";
import { ActionTypesFolder } from "../Constants/FolderConstants"
import ParsedProperty from "../Models/ParsedProperty";
import { ActionTypeContentReturn } from "../Types/ActionTypesTypes";
...
export default class ActionTypeController extends FluxController {
    ...
    public exportsActionTypeLines(modelName: string, isAppend: boolean = false) {
